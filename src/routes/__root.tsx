  ...
  head: () => ({
    meta: [
      ...
      { title: "Maury Laurent — Peinture, décoration et rénovation à Bouloc (31)" },
      {
        name: "description",
        content:
          "Entreprise familiale de peinture, décoration et rénovation à Bouloc depuis 1994. Intérieur, sols, murs, façades et entretien du bâti au nord de Toulouse.",
      },
      { name: "author", content: "Maury Laurent" },
      { property: "og:site_name", content: "Maury Laurent" },
